...
void prob_ft(double rf, int t, double *transpr)
{
  ...
  B_11 = (1/2)*((2*(- 8*r3*u3 + 8*r3*u2 + 12*r2*u3 - 12*r2*u2 - 2*d*r2*u + d*r2 - 4*r*u3 + 8*r*u2 + 2*d*r*u - 2*d*r - 2*u2 + d))/((d + 4*r*u2 - 2*u2)*(- 4*r2*u2 + 4*r*u2 - 2*u2 + d)) - (d*R_pow((-(4*r*u2 - 2*u2)/d),t))/(2*(d*u2 + 4*r*u4 - 2*u4)) + (4*hpowt*(- u*r2 + u*r))/(h*(4*r2*u2 - 4*r*u2 + 2*u2 - d*h)) + (d*R_pow(((4*r2*u2 - 4*r*u2 + 2*u2)/d),t)*(16*r2*u2 - 16*r3*u2 + 8*r4*u2 - d*h - 8*r*u2 + 2*u2 - 4*d*r2*u + 2*d*h*r + 4*d*r*u - 2*d*h*r2 - 4*d*h*r*u + 4*d*h*r2*u))/(2*(2*r2*u2 - 2*r*u2 + u2)*(32*r2*u4 - 32*r3*u4 + 16*r4*u4 + d2*h - 2*d*u2 - 16*r*u4 + 4*u4 + 4*d*r*u2 - 4*d*r2*u2 - 2*d*h*u2 + 4*d*h*r*u2 - 4*d*h*r2*u2)));
  
  B_14 = (1/2)*((d*R_pow((-(4*r*u2 - 2*u2)/d),t))/(2*(d*u2 + 4*r*u4 - 2*u4)) + (2*(- 8*r3*u3 + 12*r2*u3 - 2*d*r2*u + d*r2 - 4*r*u3 + 2*d*r*u))/((d + 4*r*u2 - 2*u2)*(- 4*r2*u2 + 4*r*u2 - 2*u2 + d)) + (4*hpowt*(- u*r2 + u*r))/(h*(4*r2*u2 - 4*r*u2 + 2*u2 - d*h)) + (d*R_pow(((4*r2*u2 - 4*r*u2 + 2*u2)/d),t)*(16*r2*u2 - 16*r3*u2 + 8*r4*u2 - d*h - 8*r*u2 + 2*u2 - 4*d*r2*u + 2*d*h*r + 4*d*r*u - 2*d*h*r2 - 4*d*h*r*u + 4*d*h*r2*u))/(2*(2*r2*u2 - 2*r*u2 + u2)*(32*r2*u4 - 32*r3*u4 + 16*r4*u4 + d2*h - 2*d*u2 - 16*r*u4 + 4*u4 + 4*d*r*u2 - 4*d*r2*u2 - 2*d*h*u2 + 4*d*h*r*u2 - 4*d*h*r2*u2)));

  B_12 = (1/4)*((4*d*(- r2 + r)*R_pow(((4*r2*u2 - 4*r*u2 + 2*u2)/d),t))/((2*u*r2 - 2*u*r + u)*(4*r2*u2 - 4*r*u2 + 2*u2 - d*h)) - (8*hpowt*(- u*r2 + u*r))/(h*(4*r2*u2 - 4*r*u2 + 2*u2 - d*h)));
  
  B_22 = (d*R_pow(((4*r2*u2 - 4*r*u2 + 2*u2)/d),t))/(4*(2*r2*u2 - 2*r*u2 + u2)) - (d*R_pow((-(4*r*u2 - 2*u2)/d),t))/(4*(2*r*u2 - u2));
  
  B_23 = (d*R_pow(((4*r2*u2 - 4*r*u2 + 2*u2)/d),t))/(4*(2*r2*u2 - 2*r*u2 + u2)) + (d*R_pow((-(4*r*u2 - 2*u2)/d),t))/(4*(2*r*u2 - u2));
