...
void prob_ft(double rf, int t, double *transpr)
{
  ...
  p2 = (1/2)*((d*(-(4*r*u^2 - 2*u^2)/d)^t)/(2*(d*u^2 + 4*r*u^4 - 2*u^4)) + (2*(- 8*r^3*u^3 + 12*r^2*u^3 - 2*d*r^2*u + d*r^2 - 4*r*u^3 + 2*d*r*u))/((d + 4*r*u^2 - 2*u^2)*(- 4*r^2*u^2 + 4*r*u^2 - 2*u^2 + d)) + (4*h^t*(- u*r^2 + u*r))/(h*(4*r^2*u^2 - 4*r*u^2 + 2*u^2 - d*h)) + (d*((4*r^2*u^2 - 4*r*u^2 + 2*u^2)/d)^t*(16*r^2*u^2 - 16*r^3*u^2 + 8*r^4*u^2 - d*h - 8*r*u^2 + 2*u^2 - 4*d*r^2*u + 2*d*h*r + 4*d*r*u - 2*d*h*r^2 - 4*d*h*r*u + 4*d*h*r^2*u))/(2*(2*r^2*u^2 - 2*r*u^2 + u^2)*(32*r^2*u^4 - 32*r^3*u^4 + 16*r^4*u^4 + d^2*h - 2*d*u^2 - 16*r*u^4 + 4*u^4 + 4*d*r*u^2 - 4*d*r^2*u^2 - 2*d*h*u^2 + 4*d*h*r*u^2 - 4*d*h*r^2*u^2)));
